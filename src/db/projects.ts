...
export const allVideoProjects: VideoProject[] = [
  ...
  {
    id: "7RHcg3bsLP4",
    video_title: "Nova foundation introduction _ Alpha net Silver Jubilee",
    video_description:
      "A documentary introduction for Nova Foundation and Alpha Net Silver Jubilee, blending storytelling, brand visuals, and cinematic pacing.",
