...
export const allVideoProjects: VideoProject[] = [
  ...
  },
  {
    ...
    video_description: "A lively raffle draw animation combining playful motion graphics, bold typography, and celebratory effects to create an engaging moment of reveal. Designed with clean animation timing and polished transitions, this piece is ideal for promotional giveaways, event highlights, and brand activations.",
    tags: ["Motion Graphics", "Promo", "Animation"],
    cover_image: "6H8qq7hUg4k",
    publish_date: "2026-07-26",
    client_name: "Motion Graphics",
    client_image: "",
    client_feedback: "",
    video_link: "https://youtu.be/6H8qq7hUg4k?si=NeKd5N1fbCH1QMYK",
    project_images: [],
    category: ["Motion Graphics"],
    duration: "",
